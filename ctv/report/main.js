...
for(let i=0; i<dataDoanhThu.length;i++){
  dataInnerDoanhThu += `<tr>
                ...
                <td><span class="text-green font-w-500">${dataDoanhThu[i].duocThanhToan}</span></td>
                <td><span class="text-red font-w-500">${dataDoanhThu[i].daHuy}</span></td>
                <td><span class="text-orange font-w-500">${dataDoanhThu[i].choXuly}</span></td>
              </tr>`;
}
