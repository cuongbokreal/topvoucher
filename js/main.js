...
freeshipVoucher.innerHTML += `<div class="row mb-3"><div class="col-4"><div class="voucher">
                   ${logoShopee}
...
var freeshipHomNay = document.getElementById('freeshipHomNay');
freeshipHomNay.innerHTML = `<div class="row mb-3"><div class="col-4"><div class="voucher">
                   ${logoShopee}
                 <div>Freeship</div></div></div>
           <div class="col-6">
